! function() {
	...
	function w(n) {
		...
		return t.on = function(t, u) {
			...
			e = e.slice(0, i = e.indexOf(o)).concat(e.slice(i + 1)), r.remove(t)), u && e.push(r.set(t, {
				on : u
			})), n)
		}, t
	}
	...
	function X(n, t, e) {
		...
		function u() {
			...
			r.call(this), this.addEventListener(n, this[o] = u, u.$ = e), u._ =
			t
		}
	...
	function ct(n, t, e) {
		...
		e = 0 > e ? 0 : e > 1 ? 1 : e,
		o = .5 >= e ? e * (1 + t) : e + t - e * t,
		i = 2 * e - o, new mt(u(n + 120), u(n), u(n - 120))
	}
	...
	function ht(n, t, e) {
		...
		return u = pt(u) * Xa,
		r = pt(r) * $a,
		i = pt(i) * Ba, new mt(dt(3.2404542 * u - 1.5371385 * r - .4985314 * i), dt(-.969266 * u + 1.8760108 * r + .041556 * i), dt(.0556434 * u - .2040259 * r + 1.0572252 * i))
	}
	...
	function _t(n, t, e) {
		...
		r = n == o ? (t - e) / a + (e > t ? 6 : 0) : t == o ? (e - n) / a + 2 : (n - t) / a + 4, r *= 60) : ( r = 0 / 0,
		u = c > 0 && 1 > c ? 0 : r), new at(r, u, c)
	}
	...
	function Nt(n, t, e, r) {
		...
		return !this.XDomainRequest || "withCredentials" in c || !/^(http(s)?:)?\/\//.test(n) || ( c = new XDomainRequest), "onload" in c ? c.onload = c.onerror = u : c.onreadystatechange = function() {
			...
			if (2 === arguments.length && "function" == typeof r && ( u = r,
				r = null), c.open(e, n, !0), null == t || "accept" in a || (a.accept = t + ",*/*"), c.setRequestHeader)
				for (var s in a)
	...
	function Pt(n) {
		...
		return function(n) {
			...
			"$" === c && ( v = u[0],
			d = u[1]), "r" != g || h || ( g = "g"), null != h && ("g" == g ? h = Math.max(1, Math.min(21, h)) : ("e" == g || "f" == g) && ( h = Math.max(0, Math.min(20, h)))),
			g = oc.get(g) || Ut;
			var M = l && f;
			return function(n) {
				var e = d;
				...
				n = x + b, ("<" === o ? u + n + k : ">" === o ? k + u + n : "^" === o ? k.substring(0, S >>= 1) + u + n + k.substring(S) : u + ( M ? n : k + n)) + e
			}
		}
	}
	...
	function Ft(n, t, e) {
		...
		o;
		var c = n.utc = Ht(n);
		return c.floor = c, c.round = Ht(r), c.ceil = Ht(u), c.offset = Ht(i), c.range =
		a, n
	}
		...
		function t(n) {
			function t(t) {
				for (var e,
				    ...
				    a = -1,
				    c = 0; ++a < r; )
					37 === n.charCodeAt(a) && (o.push(n.slice(c, a)), null != ( u = sc[ e = n.charAt(++a)]) && ( e = n.charAt(++a)), ( i = N[e]) && ( e = i(t, null == u ? "e" === e ? " " : "0" : u)), o.push(e),
					c = a + 1);
		...
		function e(n, t, e, r) {
			for (var u,
				...
				if ( u = t.charCodeAt(a++), 37 === u) {
					if ( o = t.charAt(a++),
						i = C[ o in sc ? t.charAt(a++) : o], !i || ( r = i(n, e, r)) < 0)
						return -1
	...
	function Le(n, t, e, r) {
		return function(u, i) {
			...
			var g,
				...
				polygonEnd : function() {
					y.point = o, y.lineStart =
					c, y.lineEnd =
					l,
					g = ta.merge(g);
					var n = Fe(m, p);
					g.length ? (b || (i.polygonStart(),
					b = !0), Ce(g, De, n, e, i)) : n && (b || (i.polygonStart(),
	...
	function Pe(n) {
		...
		return {
			...
			point : function(i, o) {
				...
				t = 0) : u !== a && c >= qa && (ga(e - u) < Ca && (e -= u * Ca), ga(i - a) < Ca && (i -= a * Ca),
				r = Ue(e, r, i, o), n.point(u, r), n.lineEnd(), n.lineStart(), n.point(a, r),
				t = 0), n.point( e = i, r = o),
				u =
				a
			},
	...
	function He(n) {
		...
		function e(n) {
			...
			return {
				...
				point : function(f, h) {
					...
					if (!e && ( l = c = v) && n.lineStart(), v !== c && ( g = r(e, p), (be(e, g) || be(p, g)) && (p[0] += Ca, p[1] += Ca,
						v = t(p[0], p[1]))), v !== c)
						s = 0, v ? (n.lineStart(),
						g = r(p, e), n.point(g[0], g[1])) : ( g = r(e, p), n.point(g[0], g[1]), n.lineEnd()),
						e =
						g;
					else if (a && e && o ^ v) {
						var m;
		...
		function r(n, t, e) {
			...
			if (!(0 > M)) {
				...
				E,
				E =
				_), C ? N ? k + E > 0 ^ b[1] < (ga(b[0] - w) < Ca ? k : E) : k <= b[1] && b[1] <= E : A > qa ^ (w <= b[0] && b[0] <= S)) {
					var z = ye(d, (-m + x) / y);
	...
	function Ie(n, t, e, r) {
		...
		return function(a) {
			function c(n) {
				for (var t = 0,
					...
					for (var i,
					    ...
					    c = a.length,
					    l = a[0]; c > o; ++o)
						i = a[o], l[1] <= r ? i[1] > r && Q(l, i, n) > 0 && ++t : i[1] <= r && Q(l, i, n) < 0 && --t,
						l =
						i;
				return 0 !== t
			}
			...
			function g() {
				v && (p(y, M), x && w && A.rejoin(), v.push(A.buffer())), C.point =
				f, w && a.lineEnd()
			}
	...
	function Ke() {
		function n(n, t) {
			...
			o = u * n - r * t, Nc += o * (r + n), Cc += o * (u + t), zc += 3 * o, We( r = n, u = t)
		}
	...
	function nr(n) {
		...
		function r(t) {
			...
			function s() {
				u(M, x, y, b, _, w, g, p, f, v, d, m, a, t), S.lineEnd =
				o, o()
			}
			...
			var f,
				...
				lineEnd : o,
				polygonStart : function() {
					t.polygonStart(), S.lineStart =
					c
				},
				polygonEnd : function() {
					t.polygonEnd(), S.lineStart =
					r
				}
			};
			return S
	...
	function ir(n) {
		...
		return t.stream = function(n) {
			...
			d = n[1] % 360 * Da, r()) : [v * Pa, d * Pa]
		}, t.rotate = function(n) {
			return arguments.length ? ( m = n[0] % 360 * Da,
			M = n[1] % 360 * Da,
			x = n.length > 2 ? n[2] % 360 * Da : 0, r()) : [m * Pa, M * Pa, x * Pa]
	...
	function gr(n, t) {
		...
		return function(u, i, o, a) {
			var c = o * t;
			null != u ? ( u = pr(e, u),
			i = pr(e, i), (o > 0 ? i > u : u > i) && (u += o * La)) : ( u = n + o * La,
			i = n - .5 * c);
			for (var l,
			    s =
			    u; o > 0 ? s > i : i > s; s -= c)
	...
	function Ur(n) {
		...
		for ( s = 1; f > s; ++s)
			l = a[s],
			c = a[s - 1], Kr(l.edge, c.site, l.site, u);
		c = a[0],
		l = a[f - 1], l.edge = Jr(c.site, l.site, null, u), Vr(c), Vr(l)
	}
	...
	function jr(n) {
		...
		if (Qc.insert(t, c), t || e) {
			if (t === e)
				return Xr(t),
				e = Dr(t.site), Qc.insert(c, e), c.edge = e.edge = Jr(t.site, c.site), Vr(t),
				void  Vr(e);
			if (!e)
				return
		...
		for (var t,
			...
			if ( i = v[d], i && i.prepare())
				...
				o = 0; c > o; )
					...
					l = a[++o % c].start(),
					t = l.x,
					e = l.y, (ga(r - t) > Ca || ga(u - e) > Ca) && (a.splice(o, 0, new Qr(Gr(i.site, s, ga(r - f) < Ca && p - u > Ca ? {
						x : f,
						y : ga(t - f) < Ca ? e : p
					} : ga(u - p) < Ca && h - r > Ca ? {
						x : ga(e - p) < Ca ? t : h,
			...
			if (r !== i) {
				...
				if (!(h >= -za)) {
					var g = c * c + l * l,
					    ...
					    m = rl.pop() || new Zr;
					m.arc = n, m.site =
					u, m.x = v + o, m.y = f + Math.sqrt(v * v + d * d), m.cy =
					f, n.circle =
					m;
					for (var y = null,
					    M = tl._; M; )
	...
	function Kr(n, t, e, r) {
		n.a || n.b ? n.l === e ? n.b = r : n.a = r : (n.a = r, n.l =
		t, n.r =
		e)
	}
	...
	function Qr(n, t, e) {
		var r = n.a,
		    u = n.b;
		this.edge = n, this.site =
		t, this.angle = e ? Math.atan2(e.y - t.y, e.x - t.x) : n.l === t ? Math.atan2(u.x - r.x, r.y - u.y) : Math.atan2(r.x - u.x, u.y - r.y)
	}
	...
	function eu(n, t) {
		var e = t,
		    r = t.R,
		    u = e.U;
		u ? u.L === e ? u.L = r : u.R = r : n._ = r, r.U =
		u, e.U =
		r, e.R = r.L, e.R && (e.R.U = e), r.L =
		e
	}
	...
	function iu(n, t) {
		...
		tl = new nu; ; )
			if ( u = nl, i && (!u || i.y < u.y || i.y === u.y && i.x < u.x))
				(i.x !== e || i.y !== r) && (Kc[i.i] = new Or(i), jr(i),
				e = i.x,
				r = i.y),
				i = n.pop();
			else {
	...
	function Gu(n, t) {
		return ta.rebind(n, t, "sort", "children", "value"), n.nodes =
		n, n.links =
		ri, n
	}
	...
	function Mi(n) {
		...
		if (( e = n.children) && ( l = e.length)) {
			var e,
			    ...
			    g = -1 / 0;
			if (e.forEach(xi),
				r = e[0], r.x = -r.r, r.y = 0, t(r), l > 1 && ( u = e[1], u.x = u.r, u.y = 0, t(u), l > 2))
				for ( i = e[2], wi(r, u, i), t(i), di(r, i), r._pack_prev =
				i, di(i, u),
				u = r._pack_next,
				o = 3; l > o; o++) {
					wi(r, u, i = e[o]);
	...
	function Fi(n, t) {
		...
		o,
		o =
		e), n[r] = t.floor(i), n[u] = t.ceil(o), n
	}
	...
	function Vi(n, t) {
		...
		var e = Pi(n),
		    ...
		    i = t / r * u;
		return .15 >= i ? u *= 10 : .35 >= i ? u *= 5 : .75 >= i && (u *= 2), e[0] = Math.ceil(e[0] / u) * u, e[1] = Math.floor(e[1] / u) * u + .5 * u, e[2] =
		u, e
	}
	...
	function $i(n, t, e) {
		...
		if (e) {
			...
			if (u.shift(), "s" === u[8]) {
				...
				return u[7] || (u[7] = "." + Bi(i.scale(r[2]))), u[8] = "f",
				e = ta.format(u.join("")),
				function(n) {
	...
	function Qi(n, t) {
		...
		return e.domain = function(r) {
			...
			return i = r(s + h * c, h), l && i.reverse(),
			o = h * (1 - a),
			t = {
				t : "rangeBands",
				a : arguments
	...
	function to(n, t, e) {
		...
		return r.domain = function(e) {
			...
			t = +e[e.length - 1], u()) : [n, t]
		}, r.range = function(n) {
			return arguments.length ? ( e = n, u()) : e
		}, r.invertExtent = function(t) {
			return t = e.indexOf(t),
			t = 0 > t ? 0 / 0 : t / i + n, [t, t + 1 / i]
		}, r.copy = function() {
			return to(n, t, e)
		}, u()
	}
	...
	function _o(n, t) {
		...
		c = 2), t.length > 1) {
			a = t[1],
			i = n[c], c++, r += "C" + (u[0] + o[0]) + "," + (u[1] + o[1]) + "," + (i[0] - a[0]) + "," + (i[1] - a[1]) + "," + i[0] + "," + i[1];
			for (var l = 2; l < t.length; l++, c++)
				i = n[c],
				a = t[l], r += "S" + (i[0] - a[0]) + "," + (i[1] - a[1]) + "," + i[0] + "," + i[1]
		}
		if (e) {
			var s = n[c];
	...
	function wo(n, t) {
		for (var e,
			...
			i =
			o,
			o = n[a], r.push([u * (o[0] - e[0]), u * (o[1] - e[1])]);
		return r
	}
	...
	function Lo(n) {
		for (var t,
		    ...
		    a = -1,
		    c = n.length - 1; ++a < c; )
			t = zo(n[a], n[a + 1]), ga(t) < Ca ? o[a] = o[a + 1] = 0 : ( e = o[a] / t,
			r = o[a + 1] / t,
			u = e * e + r * r, u > 9 && ( u = 3 * t / Math.sqrt(u), o[a] = u * e, o[a + 1] = u * r));
		for ( a = -1; ++a <= c; )
	...
	function Ro(n) {
		for (var t,
			...
			t = n[u],
			e = t[0],
			r = t[1] - Ra, t[0] = e * Math.cos(r), t[1] = e * Math.sin(r);
		return n
	}
	...
	function Do(n) {
		function t(t) {
			...
			for (var h,
				...
				o.call(this, h = t[y], y) ? (d.push([ g = +x.call(this, h, y), p = +b.call(this, h, y)]), m.push([+_.call(this, h, y), +w.call(this, h, y)])) : d.length && (c(),
				d = [],
				m = []);
		...
		if (!o) {
			...
			u = null, ++i.count, ta.timer(function(u) {
				function c(e) {
					...
					var u = i[i.active];
					u && (--i.count,
					delete i[i.active], u.event && u.event.interrupt.call(n, n.__data__, u.index)), i.active =
					r, o.event && o.event.start.call(n, n.__data__, t), o.tween.forEach(function(e, r) {
						( r = r.call(n, n.__data__, t)) && v.push(r)
					}),
					h = o.ease,
					f = o.duration, ta.timer(function() {
	...
	function Go(n, t, e) {
		...
		return r.invert = function(t) {
			...
			return i && ( n = i[0],
			t = i[1]), n.range(e[0], Ko(+e[1] + 1), 1 > t ? 1 : t)
	...
	ta.bisectLeft = ha.left, ta.bisect = ta.bisectRight = ha.right, ta.bisector = function(n) {
		...
		if (!( r = arguments.length))
			return [];
		for (var n = -1,
		    t = ta.min(arguments, o),
		    e = new Array(t); ++n < t; )
			for (var r,
			    u = -1,
			    i = e[n] = new Array(r); ++u < r; )
				i[u] = arguments[u][n];
		return e
	...
	ta.range = function(n, t, e) {
		if (arguments.length < 3 && ( e = 1, arguments.length < 2 && ( t = n,
			n = 0)), (t - n) / e === 1 / 0)
	...
	xa =
	Sizzle,
	ba = Sizzle.matchesSelector), ta.selection = function() {
	...
	_a.select = function(n) {
		...
		for (var u = -1,
			...
			for (var o = this[u],
			    a = -1,
			    c = o.length; ++a < c; )
				( e = o[a]) && (r.push( t = ra(n.call(e, e.__data__, a, u))), t.parentNode =
				e);
		return A(r)
	};
	var wa = {
	...
	ta.ns = {
		...
		qualify : function(n) {
			...
			n = n.slice(t + 1)), wa.hasOwnProperty(e) ? {
				space : wa[e],
				local : n
			} : n
		}
		...
		function e(n, e) {
			...
			if (t) {
				var d,
				    ...
				    y = new Array(o);
				for ( r = -1; ++r < o; )
					m.has( d = t.call( u = n[r], u.__data__, r)) ? v[r] = u : m.set(d, u), y[r] =
					d;
				for ( r = -1; ++r < f; )
					( u = m.get( d = t.call(e, i = e[r], r))) ? u !== !0 && (g[r] = u, u.__data__ =
					i) : p[r] = H(i), m.set(d, !0);
				for ( r = -1; ++r < o; )
					m.get(y[r]) !== !0 && (v[r] = n[r])
			} else {
	...
	var Sa = [];
	ta.selection.enter = Z, ta.selection.enter.prototype =
	Sa, Sa.append = _a.append, Sa.empty = _a.empty, Sa.node = _a.node, Sa.call = _a.call, Sa.size = _a.size, Sa.select = function(n) {
		for (var t,
		    e,
		    r,
		    u,
	...
	ta.interpolateZoom = function(n, t) {
		...
		function o(t, e, r, o) {
			t.__chart__ = {
				...
				y : k.y,
				k : k.k
			}, u(Math.pow(2, o)), i( d = e, r),
			t = ta.select(t), C > 0 && ( t = t.transition().duration(C)), t.call(n.event)
		}
	...
	Et, ta.xhr = At(y), ta.dsv = function(n, t) {
		function e(n, e, i) {
	...
	ta.geo.bounds = function() {
		...
		function o() {
			u(v, d), Mc.lineEnd(), ga(y) > Ca && ( s = -( h = 180)), x[0] =
			s, x[1] =
			h,
			m = null
		}
		...
		var s,
			...
			lineEnd : r,
			polygonStart : function() {
				b.point = u, b.lineStart =
				i, b.lineEnd =
				o,
				y = 0, Mc.polygonStart()
			},
			polygonEnd : function() {
				Mc.polygonEnd(), b.point =
				n, b.lineStart =
				e, b.lineEnd =
				r, 0 > yc ? ( s = -( h = 180),
				f = -( g = 90)) : y > Ca ? g = 90 : -Ca > y && ( f = -90), x[0] =
				s, x[1] =
				h
			}
		};
		...
		r =
		Sc),
		u = t * t + e * e + r * r, za > u) ? [0 / 0, 0 / 0] : [Math.atan2(e, t) * Pa, tt(r / Math.sqrt(u)) * Pa]
	};
	var xc,
	    bc,
	    _c,
	...
	ta.geo.clipExtent = function() {
		var n,
			...
			extent : function(a) {
				return arguments.length ? ( i = Ie( n = +a[0][0], t = +a[0][1], e = +a[1][0], r = +a[1][1]), u && (u.valid = !1,
				u = null), o) : [[n, t], [e, r]]
			}
		};
	...
	Ze, ta.geo.albers = function() {
		...
		return n.invert = function(n) {
			...
			u = a.translate([s - .205 * l, f + .212 * l]).clipExtent([[s - .214 * l + Ca, f + .166 * l + Ca], [s - .115 * l - Ca, f + .234 * l - Ca]]).stream(c).point, n
		}, n.scale(1070)
	};
	var Rc,
	    Dc,
	...
	ur, ta.geo.projectionMutator =
	ir, (ta.geo.equirectangular = function() {
		return ur(ar)
	...
	ar, ta.geo.circle = function() {
		...
		return n.distance = function() {
			...
			t = "function" == typeof e ? null : e, n) : r
		}, n.target = function(t) {
			return arguments.length ? ( u = t,
			e = "function" == typeof t ? null : t, n) : u
	...
	_r, (ta.geo.conicEquidistant = function() {
		return Ye(wr)
	}).raw =
	wr;
	var $c = br(function(n) {
	...
	Er, ta.geom = {}, ta.geom.hull = function(n) {
		function t(n) {
			if (n.length < 3)
				return [];
			var t,
	...
	Jc.area = function() {
		...
		for (var t,
		    ...
		    s = this[l - 1]; ++c < l; ) {
			for ( t = n.slice(), n.length = 0,
			u = this[c],
			i = t[( r = t.length - a) - 1],
			e = -1; ++e < r; )
				o = t[e], qr(o, s, u) ? (qr(i, s, u) || n.push(Lr(i, o, s, u)), n.push(o)) : qr(i, s, u) && n.push(Lr(i, o, s, u)),
				i =
				o;
			a && n.push(n[0]),
			s =
	...
	Or.prototype.prepare = function() {
		...
		insert : function(n, t) {
			var e,
			    ...
			    u;
			if (n) {
				if (t.P = n, t.N = n.N, n.N && (n.N.P = t), n.N =
				t, n.R) {
					for ( n = n.R; n.L; )
						n = n.L;
					n.L = t
				...
				this._ ? ( n = uu(this._), t.P = null, t.N =
				n, n.P = n.L = t,
				e =
				n) : (t.P = t.N = null, this._ =
				t,
				e = null);
			for (t.L = t.R = null, t.U =
			e, t.C = !0,
			n =
			t; e && e.C; )
				r = e.U, e === r.L ? ( u = r.R, u && u.C ? (e.C = u.C = !1, r.C = !0,
				n =
				r) : (n === e.R && (eu(this, e),
				n =
				e,
				e = n.U), e.C = !1, r.C = !0, ru(this, r))) : ( u = r.L, u && u.C ? (e.C = u.C = !1, r.C = !0,
				n =
				r) : (n === e.L && (ru(this, e),
				n =
				e,
				e = n.U), e.C = !1, r.C = !0, eu(this, r))),
				e = n.U;
			this._.C = !1
		},
		remove : function(n) {
			...
			var t,
			    ...
			    i = n.L,
			    o = n.R;
			if ( e = i ? o ? uu(o) : i : o, u ? u.L === n ? u.L = e : u.R = e : this._ = e, i && o ? ( r = e.C, e.C = n.C, e.L =
			i, i.U =
			e, e !== o ? ( u = e.U, e.U = n.U,
			n = e.R, u.L =
			n, e.R =
			...
			e), n && (n.U = u), !r) {
				...
				do {
					if (n === this._)
						break;
					if (n === u.L) {
						if ( t = u.R, t.C && (t.C = !1, u.C = !0, eu(this, u),
						t = u.R), t.L && t.L.C || t.R && t.R.C) {
							t.R && t.R.C || (t.L.C = !1, t.C = !0, ru(this, t),
							t = u.R), t.C = u.C, u.C = t.R.C = !1, eu(this, u),
							n = this._;
							break
						}
					} else if ( t = u.L, t.C && (t.C = !1, u.C = !0, ru(this, u),
					t = u.L), t.L && t.L.C || t.R && t.R.C) {
						t.L && t.L.C || (t.R.C = !1, t.C = !0, eu(this, t),
						t = u.L), t.C = u.C, u.C = t.L.C = !1, ru(this, u),
						n = this._;
						break
					}
					t.C = !0,
		...
		return n ? t(n) : (t.links = function(n) {
			...
			return iu(e(n)).cells.forEach(function(e, r) {
				for (var u,
					...
					f,
					s = a[c].edge,
					f = s.l === o ? s.r : s.l, r < i.i && r < f.i && au(o, i, f) < 0 && t.push([n[r], n[i.i], n[f.i]])
			}), t
		}, t.x = function(n) {
		...
		function i(n) {
			...
			function l(n, t, e, r, u, o, a, c) {
				var l = .5 * (u + a),
				    ...
				    g = h << 1 | f;
				n.leaf = !1,
				n = n.nodes[g] || (n.nodes[g] = su()), f ? u = l : a = l, h ? o = s : c = s, i(n, t, e, r, u, o, a, c)
			}
	...
	gu, ta.interpolateObject =
	pu, ta.interpolateNumber =
	vu, ta.interpolateString =
	du;
	var il = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,
	...
	ta.ease = function(n) {
		...
		r = ll.get(r) || y, Mu(r(e.apply(null, ea.call(arguments, 1))))
	}, ta.interpolateHcl =
	Lu, ta.interpolateHsl =
	Tu, ta.interpolateLab =
	Ru, ta.interpolateRound =
	Du, ta.transform = function(n) {
	...
	ta.interpolateTransform = Hu, ta.layout = {}, ta.layout.bundle = function() {
		...
		return a.tick = function() {
			...
			for ( e = 0; _ > e; ++e)
				...
				h = a.target,
				y = h.x - f.x,
				x = h.y - f.y, ( p = y * y + x * x) && ( p = r * i[e] * (( p = Math.sqrt(p)) - u[e]) / p, y *= p, x *= p, h.x -= y * ( d = f.weight / (h.weight + f.weight)), h.y -= x * d, f.x += y * ( d = 1 - d), f.y += x * d);
			if (( d = r * v) && ( y = l[0] / 2,
				x = l[1] / 2,
				e = -1, d))
				for (; ++e < b; )
			...
			for (u.depth = 0; null != ( i = o.pop()); )
				if (a.push(i), ( l = e.call(n, i, i.depth)) && ( c = l.length)) {
					for (var c,
					    l,
					    s; --c >= 0; )
						o.push( s = l[c]), s.parent =
						i, s.depth = i.depth + 1;
					r && (i.value = 0), i.children =
					l
				} else
		...
		function u(n, t, e) {
			if (t) {
				...
				u = ki(u), o && u; )
					...
					i = Ei(i), i.a =
					n,
					r = o.z + f - u.z - l + a(o._, u._), r > 0 && (Ai(Ci(o, n, e), n, r), l += r, s += r), f += o.m, l += u.m, h += c.m, s += i.m;
				o && !Ei(i) && (i.t = o, i.m += f - s), u && !ki(c) && (c.t = u, c.m += l - h,
				e =
				n)
			}
			return e
		...
		function t(e) {
			...
			if (i && i.length) {
				...
				for (n(h, l.dx * l.dy / e.value), s.area = 0; ( c = h.length) > 0; )
					s.push( o = h[c - 1]), s.area += o.area, "squarify" !== g || ( a = r(s, v)) <= p ? (h.pop(),
					p =
					a) : (s.area -= s.pop().area, u(s, v, l, !1),
		...
		function u(n, t, e, r) {
			...
			if (t == e.dx) {
				for ((r || s > e.dy) && ( s = e.dy); ++i < o; )
					...
					a, u.y =
					l, u.dy =
					s, a += u.dx = Math.min(e.x + e.dx - a, s ? c(u.area / s) : 0);
				...
				for ((r || s > e.dx) && ( s = e.dx); ++i < o; )
					...
					a, u.y =
					l, u.dx =
					s, l += u.dy = Math.min(e.y + e.dy - l, s ? c(u.area / s) : 0);
	...
	}, ta.transition.prototype =
	Pl, Pl.select = function(n) {
		var t,
		    e,
		    r,
		    u = this.id,
		...
		for (var l = -1,
			...
			for (var f = this[l],
				...
				if ( r = f[h]) {
					i = r[a][o],
					e = n.call(r, r.__data__, h, l), c.push( t = []);
					for (var p = -1,
					    v = e.length; ++p < v; )
		...
		function n(n) {
			n.each(function() {
				...
				k = "y",
				S = "x2",
				E = "y2", C.attr("dy", 0 > L ? "0em" : ".71em").style("text-anchor", "middle"), _.attr("d", "M" + x[0] + "," + L * i + "V0H" + x[1] + "V" + L * i)) : ( n = Wo,
				w = "y",
				k = "x",
				S = "y2",
				E = "x2", C.attr("dy", ".32em").style("text-anchor", 0 > L ? "end" : "start"), _.attr("d", "M" + L * i + "," + x[0] + "H0V" + x[1] + "H" + L * i)), A.attr(E, L * u), z.attr(k, L * M), N.attr(S, 0).attr(E, L * u), q.attr(w, 0).attr(k, L * M), f.rangeBand) {
					var T = f,
					    R = T.rangeBand() / 2;
					s = f = function(n) {
						return T(n) + R
	...
	ta.svg.brush = function() {
		...
		function i() {
			function i() {
				32 == ta.event.keyCode && (C || ( M = null, q[0] -= f[1], q[1] -= h[1],
				C = 2), S())
			}

			function v() {
				32 == ta.event.keyCode && 2 == C && (q[0] += f[1], q[1] += h[1],
				C = 0, S())
			}
			...
			function d() {
				var n = ta.mouse(b),
				    t = !1;
				x && (n[0] += x[0], n[1] += x[1]), C || (ta.event.altKey ? (M || ( M = [(f[0] + f[1]) / 2, (h[0] + h[1]) / 2]), q[0] = f[+(n[0] < M[0])], q[1] = h[+(n[1] < M[1])]) : M = null), A && m(n, l, 0) && (r(k),
				t = !0), N && m(n, s, 1) && (u(k),
				t = !0), t && (e(k), w({
					type : "brush",
					mode : C ? "move" : "resize"
			...
			function m(n, t, e) {
				var r,
				    ...
				    d = v[1] - v[0];
				return C && (c -= s, l -= d + s),
				r = ( e ? p : g) ? Math.max(c, Math.min(l, n[e])) : n[e], C ? u = (r += s) + d : (M && ( s = Math.max(c, Math.min(l, 2 * M[e] - r))), r > s ? ( u = r,
				r =
				s) : u = s), v[0] != r || v[1] != u ? ( e ? a = null : o = null, v[0] =
				r, v[1] =
				u, !0) :
				void 0
			}
		...
		return n.event = function(n) {
			...
			p = !!t[1]) : l ? g = !!t : s && ( p = !!t), n) : l && s ? [g, p] : l ? g : s ? p : null
		}, n.extent = function(t) {
			var e,
			    r,
			    u,
			...
			r = t[1], s && ( e = e[0],
			r = r[0]),
			o = [e, r], l.invert && ( e = l(e),
			r = l(r)), e > r && ( c = e,
			e =
			r,
			r =
			c), (e != f[0] || r != f[1]) && ( f = [e, r])), s && ( u = t[0],
			i = t[1], l && ( u = u[1],
			i = i[1]),
			a = [u, i], s.invert && ( u = s(u),
			i = s(i)), u > i && ( c = u,
			u =
			i,
			i =
			c), (u != h[0] || i != h[1]) && ( h = [u, i])), n) : (l && ( o ? ( e = o[0],
			r = o[1]) : ( e = f[0],
			r = f[1], l.invert && ( e = l.invert(e),
			r = l.invert(r)), e > r && ( c = e,
			e =
			r,
			r =
			c))), s && ( a ? ( u = a[0],
			i = a[1]) : ( u = h[0],
			i = h[1], s.invert && ( u = s.invert(u),
			i = s.invert(i)), u > i && ( c = u,
			u =
			i,
			i =
			c))), l && s ? [[e, u], [r, i]] : l ? [e, r] : s && [u, i])
		}, n.clear = function() {
